...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
 ...
 <body>
   <center>
	...
	?>
	<form id="cadastro" name="form1" method="post" action="dados_cliente2.php"  >
	 <tr>
     ...
     <td><input name="id_1" src="images/editar.gif" type="image" id="id" size="10" value="<?php echo $linha['idcliente']; ?>" /></td>
	...
	?>
	<center><big>Nenhum prontuario cadastrado!</big></center>
