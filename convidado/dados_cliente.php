...
<body background="images/fundo.png">
   ...
   <form id="cadastro" name="form1" method="post" action="update_cadastro.php" enctype="multipart/form-data" >
	...
	<a href="#popup_aparencia" target="_blank" onclick="popup_aparencia()"><img src="images/pdf_icon.png"></a> </a>
